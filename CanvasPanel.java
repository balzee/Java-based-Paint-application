	...
	public void SaveCanvasToFile()
	{
		if(fileName != null)
		{
			...
			try
			{
				...
				JOptionPane.showMessageDialog(null,"File Saved","Bpaint",JOptionPane.INFORMATION_MESSAGE);
			}catch(Exception exp){}
...
/*----------------------------------------------------------------------------*/
	public void SaveAsCanvasToFile()
	{
		...
		if(fileName == null || fileName.getName().equals(""))
			JOptionPane.showMessageDialog(null,"Invalid File Name","Bpaint",JOptionPane.ERROR_MESSAGE);
		else
		{
			vFile.removeAllElements();
			vFile.addElement(vFreeHand);
	...
	public void OpenCanvasFile()
	{
		...
		if(fileName != null)
		{
			try{
				...
				JOptionPane.showMessageDialog(null,"Can't Open File","Bpaint",JOptionPane.INFORMATION_MESSAGE);
			}	
		}
		else{
			fileName = null;
