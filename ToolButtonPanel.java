...
{
	private JButton lineBtn, squareBtn, ovalBtn, polygonBtn, roundRectBtn, freeHandBtn, undoBtn, redoBtn, clearBtn,copyBtn,translateBtn,rotateBtn,xBtn,yBtn,zBtn;		
...
/*----------------------------------------------------------------------------*/		 
		...
		//yBtn		= new JButton("",new ImageIcon(getClass().getResource("lineBtn.gif")));
		//xBtn			= new JButton("",new ImageIcon(getClass().getResource("new.gif")));
		//zBtn			= new JButton("",new ImageIcon(getClass().getResource("width.gif")));
		...
		//xBtn.addActionListener(new ToolButtonListener());
		//xBtn.setToolTipText("New File");
		/*----------------------------------------------------------------------------*/		
